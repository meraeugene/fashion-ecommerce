...
const Secret = () => {
  return (
    <div className=" flex  flex-col mt-20 px-4 md:px-24 lg:px-32 lg:mt-32 xl:px-38  ">
      ...
      <div className="flex  mt-6 flex-wrap md:flex-nowrap md:gap-12 md:mt-12 xl:justify-between">
        <p className="md:[writing-mode:vertical-lr] md:rotate-180 lg:mb-8 xl:text-lg xl:mb-12">
          PHOTOGRAPHY 2022
        </p>
